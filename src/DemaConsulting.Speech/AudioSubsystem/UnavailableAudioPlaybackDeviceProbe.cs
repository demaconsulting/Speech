...
/// <summary>
///     Honest fallback <see cref="IAudioPlaybackDeviceProbe"/> used when no real playback backend
...
///     number of callers.
/// </remarks>
public sealed class UnavailableAudioPlaybackDeviceProbe : IAudioPlaybackDeviceProbe
{
    /// <summary>
    ...
    /// </summary>
    private UnavailableAudioPlaybackDeviceProbe()
    {
    }

    /// <summary>
    ///     Gets the single shared unavailable playback device probe.
    /// </summary>
    public static UnavailableAudioPlaybackDeviceProbe Instance { get; } = new();
